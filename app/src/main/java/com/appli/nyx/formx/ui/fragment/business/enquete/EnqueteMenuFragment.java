...
public class EnqueteMenuFragment extends ViewModelFragment<EnqueteViewModel> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.card_joinenquete).setOnClickListener(v -> NavHostFragment.findNavController(EnqueteMenuFragment.this).navigate(R.id.action_enqueteMenuFragment_to_enqueteListFragment));
        view.findViewById(R.id.card_newenquete).setOnClickListener(null);
        view.findViewById(R.id.card_myinvitations).setOnClickListener(v -> NavHostFragment.findNavController(EnqueteMenuFragment.this).navigate(R.id.action_enqueteMenuFragment_to_enqueteListFragment));
